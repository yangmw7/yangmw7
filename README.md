...
### ☁️ AWS 클라우드 엔지니어 지망생 | 백엔드 개발자

> 확장 가능한 클라우드 인프라와 백엔드 시스템 구축에 열정을 가지고 있습니다
...
![정보처리산업기사](https://img.shields.io/badge/🇰🇷_정보처리산업기사-0052CC?style=flat-square&logoColor=white)
...
- 🎓 **졸업작품 장려상** - [LOOPER: 2D 로그라이크 게임 통합 웹 플랫폼](https://github.com/yangmw7/looper_backend)  
  - 역할: 풀스택 개발 (Spring Boot, React, MCP 챗봇 통합)

## 📫 연락처

- GitHub: [@yangmw7](https://github.com/yangmw7)
